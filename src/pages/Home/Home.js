...
export default function Home() {
  const solutions = {
    ...
    head2:
      "We are technology solutions providing company all over the world doing over 3years.",
  ...
  const clients = {
    ...
    head2:
      "we actually  look into our experts accounts with view only access or screen sharing to see with our own eyes.",
    head3: `We believe in true partnerships with our clients. Become one of them. he world's best brands trust us with their products. Explore our selected cases and convince yourself of our pragmatic and user-centered approach. `,
  };
